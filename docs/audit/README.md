...
| --- | --- | --- |
| [2026-09-14 — lệnh cấm lọt qua PowerShell và tiền tố bọc](2026-09-14-lenh-cam-lot-qua-powershell-va-tien-to.md) | Lớp chặn so chuỗi lệnh theo từng công cụ; một công cụ shell thứ hai và một tiền tố bọc đều đi vòng. Cổng §1 chỉ đối chiếu văn bản cấu hình với văn bản `CLAUDE.md`, không thử hành vi chặn | Deny ba dạng kèm §1 kiểm ba dạng; hook `PreToolUse`; dòng nợ C4 (phần còn lại) ở [`../RULES.md`](../RULES.md) §10 |
| [2026-09-12 — phép dò neo vào mục thay vì vai của chuỗi](2026-09-12-cong-neo-vao-muc-thay-vi-vai-tro-cua-chuoi.md) | Luật nói về vai của chuỗi, phép dò neo vào mục chứa chuỗi; bản dò đầu báo sai mọi ca | Luật D28 — `check-docs.sh` §18 neo vào vị trí định danh; dòng nợ về chạy cổng mới trên repo thật ở [`../RULES.md`](../RULES.md) §10 |
| [2026-09-11 — lệnh kiểm tự đếm chính nó](2026-09-11-lenh-kiem-tu-dem-chinh-no.md) | Lệnh kiểm kê trong văn xuôi neo vào chuỗi giá trị, nên đếm cả dòng nhắc tên và chính khối lệnh; không cổng nào chạy lệnh kê trong tài liệu | Dòng nợ *mọi khối lệnh trong tài liệu phải chạy được* ở [`../RULES.md`](../RULES.md) §10 |
